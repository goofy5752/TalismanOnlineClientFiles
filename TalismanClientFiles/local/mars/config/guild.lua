...
GuildCreateNeedMoney = 5000000;	    -- 公会创建需要金币
GuildMemberCapacity = { 100, 100, 100, 200, 200, 200, 300, 300, 500 ,999 };   -- 公会的人数上限
GuildHouseHoldCapacity = { 3, 3, 4, 4, 5 , 5, 6 , 6 , 6 , 6};     -- 公会的堂上限
GuildTerrEnable = true;		        -- 是否开启公会领地系统
GuildTerrApplyMemberCount = 1;		-- 公会领地申请需要公会人数
GuildTerrApplyMoney = 20000000;	    -- 公会领地申请需要金币
GuildTerrSceneId = 9;		        -- 公会领地的场景ID
MainToTerrPos = { 339, 101, 0 };    -- 公会领地的默认传送位置
TerrToMainPos = { 245, -479, 0 };   -- 公会领地传送回主场景的默认位置
GuildTerrContriMoney_Rate = 1;     -- 1金可以兑换的贡献度
GuildTerrContri_EveryDay = 2000000;     -- 每天最多可以兑换的贡献度
